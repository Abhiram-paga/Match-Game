...
class App extends Component {
  ...
  onPlayAgain = () => {
    this.setState({isGameFinished: false, score: 0, seconds: 60})
    this.onDecrementSeconds()
  }
  ...
  generateRandomImage = () => {
    ...
    this.setState({imageToBeMatched: imagesList[RandomNum]})
  }
        ...
        <ul className="nav-bar-container">
          ...
          <li className="score-timer-container">
            ...
            <div className="timer-sec-con">
              ...
              />
              <p className="seconds-para">{seconds} secs</p>
            </div>
          </li>
        </ul>
        ...
        <div className="bottom-container">
          {isGameFinished ? (
            ...
            <div className="inner-container">
              <img
                src={imageToBeMatched.imageUrl}
                alt="match"
                className="img-to-be-matched"
              />
              ...
              <ul className="images-list-container">
                {filteredImages.map(eachImg => (
                  <ImageItem
                    ...
                    key={eachImg.id}
                    onThumnailClick={this.onThumnailClick}
                  />
                ))}
              </ul>
            </div>
